...
public final class PrefManager {
    ...
    private final static String SHARED_PRESENCES_NAME = "com.example.azakary";
    ...
    public static SharedPreferences getPreferences() {
        ...
        throw new RuntimeException(
                "PrefManager class not correctly instantiated. Please call Builder.setContext().build() in the Application class onCreate.");
    }
...
//        Log.i("PrefManager", "putGsonString: key = " + key + " value = " + value);
//
...
//    public static void putStringArrayList(String key ,ArrayList<String> stringArrayList){
//        Gson gson = new Gson();
//        String json = gson.toJson(stringArrayList);
//        putString(key,json);
//    }
//
//    public static ArrayList<String> getStringArrayList(final String key, final String defaultValue){
//        Gson gson = new Gson();
...
//    }
     ...
     * onCreate. And in the rest of the code base you can call PrefManager.method name.
     */
    ...
    public final static class Builder {
        ...
        public void build() {
            if (mContext == null) {
                throw new RuntimeException("Context not set, please set context before building the PrefManager instance.");
            }
            ...
            PrefManager.initPrefs(mContext);
        }
    }
}